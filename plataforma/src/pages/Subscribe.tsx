...
function Subscribe() {
  ...
  return (
    <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
      <div className="w-full max-w-[1100px] flex flex-col items-center md:flex-row md:justify-between mt-20 mx-auto">
        <div className="max-w-[640px] mx-12 text-center md:text-left">
        ...
        <div className="p-8 bg-gray-700 border border-gray-500 rounded w-full mt-8 md:mr-8 md:max-w-sm">
